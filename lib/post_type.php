 ...
 */
function elodin_resources_register_post_types() {
	...
	$post_type = 'resources';
	$slug = 'resources';
	$icon = 'screenoptions'; //* https://developer.wordpress.org/resource/dashicons/
...
add_action( 'init', 'elodin_resources_register_post_types' );